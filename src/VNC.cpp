...
bool arduinoVNC::_rfb_negotiate_protocol() {
	...
	char majorStr[4] { msg[4], msg[5], msg[6], 0x00 };		/*! \warning Check the syntax for this statement; it may be illegal. */
	char minorStr[4] { msg[8], msg[9], msg[10], 0x00 };		/*! \warning Check the syntax for this statement; it may be illegal. */
...
#if defined(VNC_RICH_CURSOR) || defined(__DOXYGEN__)
